...
public class MyWindow extends JFrame {
    ...
    private JTextField login = new JTextField("login1");
    private JPasswordField password = new JPasswordField("pass1");
    private JButton authBtn = new JButton("authorisation");
    ...
    private void createAuthPanel() {
        ...
        System.out.println(" Подключение к серверу установится после нажатия кнопки authorization");
    }
